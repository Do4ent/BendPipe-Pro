...
test("A20: real first 80003043 EdgeBreaker workspace reconstructs exact triangle connectivity", () => {
  const workspace = Uint8Array.from(Buffer.from(FIRST_80003043_SHELL_WORKSPACE_B64, "base64"));
